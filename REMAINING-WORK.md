...
Stand: 18.09.2026, Branch `fix/coderabbit-findings-audit`, Commit `1be2275`.
...
- [ ] **`Package.swift` — swift-tools-version anheben.** Das Manifest steht auf
...
- [ ] **Xcode-Projekt — Deployment-Targets anheben.**
...
- [ ] **`scripts/test-native-transport.sh` — eingebettetes Manifest aktualisieren.**
...
- [ ] Danach CI neu laufen lassen und beide Jobs auf grün prüfen.

## 2. PR #18 — Merge-Voraussetzungen

- [ ] Beide fehlgeschlagenen Checks auf grün (siehe oben).
